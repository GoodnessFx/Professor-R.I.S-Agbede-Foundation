  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50">
      <motion.a
        ...
        className="relative flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-[#25D366] text-white rounded-full shadow-xl hover:shadow-2xl transition-shadow duration-300"
