/**
 * Donate page - Donation form powered by Flutterwave (NGN & USD)
 */
...
export function DonatePage() {
    ...
    try {
      ...
      FlutterwaveCheckout({
        ...
        callback: async function (payment: any) {
          try {
            setLoading(true);
            const res = await fetch(`/api/flutterwave/verify?transaction_id=${payment.transaction_id}`);
            ...
            if (verifyData.success) {
              ...
              alert('Payment verification failed. Please contact us if your money was deducted.');
            }
          } catch (error) {
            console.error(error);
            alert('Error verifying payment. Please contact us if your money was deducted.');
          } finally {
            setLoading(false);
          }
        },
  ...
  const currentAmounts = currency === 'USD' ? USD_DONATION_AMOUNTS : NGN_DONATION_AMOUNTS;
              ...
              >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 text-sm text-gray-600 flex items-start gap-2">
                    ...
                    <p>
                      Payments are processed securely via Flutterwave. You can pay by card, bank
                      transfer, or USSD — no account required.
                    </p>
                  </div>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        <CheckCircle size={24} /> Thank You for Your Donation!
                      </>
                    ) : (
